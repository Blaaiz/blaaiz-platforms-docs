...
1. You tell Blaaiz the **amount** and the **payer's email**.
   ...
   <Frame>
     <img src="/images/interac-request-step-1.png" alt="Enter the Interac request amount and payer email" style={{ borderRadius: '0.5rem' }} />
   </Frame>

2. Blaaiz sends an Interac money request to that email.

   <Frame>
     <img src="/images/interac-request-step-2.png" alt="Interac money request sent to the payer email" style={{ borderRadius: '0.5rem' }} />
   </Frame>

3. The payer opens their banking app and **approves** the request.

   <Frame>
     <img src="/images/interac-request-step-3.png" alt="Payer approves the Interac money request in their banking app" style={{ borderRadius: '0.5rem' }} />
   </Frame>

4. The funds are sent and Blaaiz credits your CAD wallet.

   <Frame>
     <img src="/images/interac-request-step-4.png" alt="Blaaiz credits the CAD wallet after the Interac request is approved" style={{ borderRadius: '0.5rem' }} />
   </Frame>
