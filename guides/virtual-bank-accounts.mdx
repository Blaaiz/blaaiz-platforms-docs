...
<Tabs>
  <Tab title="All Currencies">
    ...
    **Accepted identity documents**
    ...
    Only a **Driver's License**, **Passport**, or **Resident Permit** is accepted for individual customers. For business customers, only a **Certificate of Incorporation** is accepted. **ID cards (National Identity Cards) are not accepted.** No other document types are supported.
