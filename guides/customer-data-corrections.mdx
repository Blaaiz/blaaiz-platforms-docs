...
- **Use the right document type.** Individual customers must use a `drivers_license`, `passport`, or `resident_permit`. Business customers must use `certificate_of_incorporation`. If you present the wrong options in your UI, your users will select the wrong type, and you will end up needing a correction.
