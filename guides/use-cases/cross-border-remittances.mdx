...
1. **Onboard the sender** — [Create a customer](/api-reference/customer/create) with identity documents for KYC verification. Only a **Driver's License** or **Passport** is accepted for individual customers. Only a **Certificate of Incorporation** is accepted for business customers. **ID cards (National Identity Cards) are not accepted.** All document images must be clear and legible — unclear images will be rejected, and repeated submission of fraudulent documents will result in the customer being permanently blacklisted.
