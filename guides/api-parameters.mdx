...
- `identity` – Identity document. **Required** to verify a customer. For individual customers, this must be a **Driver's License** or **Passport**. For business customers, this must be a **Certificate of Incorporation**. **ID cards (National Identity Cards) are not accepted.** No other document types are supported.
...
<Warning>
No other identity document types are accepted. **ID cards (National Identity Cards) are not accepted.** Resident permits and any other document types are also **not supported**. Individual customers must provide either a Driver's License or a Passport. Business customers must provide a Certificate of Incorporation.
</Warning>
