---
title: NGN
description: Webhook payload for NGN payout transactions
---

When your NGN payouts are confirmed, details about the transaction are sent in a payload that provides essential information for record-keeping and reconciliation.
