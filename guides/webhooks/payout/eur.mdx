---
title: EUR
description: Webhook payload for EUR payout transactions
---

When your EUR payouts are confirmed, details about the transaction are sent in a payload that provides essential information for record-keeping and reconciliation.
...
| `transaction_currency`           | The currency in which the transaction is conducted (EUR). |
...
| `recipient.iban`                 | The iban of the recipient.                                |
