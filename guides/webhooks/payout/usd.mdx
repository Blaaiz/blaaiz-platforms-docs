...
<Warning>
**The Payout API no longer supports crypto payouts.** The Payout API does not send crypto payout webhooks. Use [Webhook events](/guides/webhooks/events) for Crypto API webhook data.
</Warning>
