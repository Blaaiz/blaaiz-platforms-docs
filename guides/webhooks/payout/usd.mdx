...
<Warning>
**Fiat-to-crypto payouts are discontinued.** The Payout API no longer sends fiat balances to crypto wallets, so do not expect crypto-payout webhook data from this flow. Crypto collections remain available for eligible, crypto-enabled businesses, and we are building a dedicated, full-featured Crypto module for future crypto functionality. More soon.
</Warning>
