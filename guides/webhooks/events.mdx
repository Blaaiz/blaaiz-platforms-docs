...
- `customer.created`, `customer.verified`, and `customer.rejected` are sent to your `collection_url`.
- Virtual account events are also sent to your `collection_url`.
- Payout events are sent to your `payout_url`.
...
- `virtual_account.ready` — Virtual account ready to receive funds
- `virtual_account.rejected` — Virtual account verification rejected
- `virtual_account.failed` — Virtual account creation failed
- `virtual_account.credited` — Funds received in virtual account

> `customer.created`, `customer.verified`, `customer.rejected`, and virtual account events are delivered to your configured `collection_url`. Payout events are delivered to your `payout_url`.
