...
<Note>
Payout and crypto payout events use your `payout_url`. Merchant KYC events use your `kyc_url`. Crypto deposit events and all other events use your `collection_url`.
</Note>
