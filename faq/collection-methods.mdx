...
- Generate a USD virtual account for your customer via our API. The customer must be **`type=individual`** — USD virtual accounts for `type=business` customers are not yet supported.
