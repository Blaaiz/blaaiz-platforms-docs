...
## Where do I find my API keys and webhook settings?
...
From there, you can manage your API keys (up to 3), configure webhook URLs, and view webhook logs.

<Frame>
  <img src="/images/api-webhooks-page.png" alt="API & Webhooks page showing API key management" style={{ borderRadius: '0.5rem' }} />
</Frame>

<Warning>
  API keys are environment-specific. For the dev environment, create a separate account at [business-dev.blaaiz.com](https://business-dev.blaaiz.com) — keys generated there will not work in production and vice versa.
</Warning>
