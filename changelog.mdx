  ...
  <div className="changelog-list">
    ...
    <div className="changelog-item">
      ...
      <div className="changelog-card">
        ...
        <p>
          You can now manage business crypto wallets through API Services.
          You can create crypto wallets and get their addresses and transactions.
