      ...
      <div className="changelog-card">
        ...
        <ul>
          ...
          <li>
            ...
            <a href="/api-reference/customer/submit">
              <code>POST /customer/{"{customer}"}/submit</code>
            </a>.
          </li>
          <li>
            <strong>
          ...
          <li>
            <strong>
              Customer-level <code>country</code> is no longer required for business
              customers
            </strong>
            . If omitted, the system auto-fills it from{" "}
            <code>incorporation_country</code> so downstream operations behave
            identically. Individuals continue to require <code>country</code>.
          </li>
          <li>
        ...
        <p>
          <strong>Rules <code>/submit</code> enforces for business customers</strong>{" "}
          (each returns <code>422</code> with a specific message):
        </p>
        <ul>
          <li>At least one beneficial owner.</li>
          <li>
            <strong>
              Owner <code>ownership_percentage</code> values must sum to exactly 100
            </strong>
            . 99.99% won't pass.
          </li>
          <li>
