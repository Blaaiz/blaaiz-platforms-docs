...
- **Customer** - Create and manage customers (both `type=individual` with KYC and `type=business` with KYB), their KYC/KYB data, beneficial owners, and KYB document collections
- **Webhook** - Configure and manage webhook URLs

Merchant KYC has its own section. It lets you verify the identity of your own customers with verification sessions. See the [Compliance](/compliance/overview) tab for its guides and its endpoints.
