...
API keys are generated from the **API Settings** page in the Blaaiz dashboard after API Services have been enabled for your account. Development and production use different API keys.
