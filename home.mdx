...
<div className="home-page">
  ...
  <div className="home-container">
    <Warning>
      **The Payout API no longer supports crypto payouts.** Use the [Crypto API](/guides/crypto-api) to swap a business wallet balance and send an on-chain crypto payout. Crypto collections remain available for eligible, crypto-enabled businesses.
    </Warning>
    ...
    <section className="home-section">
      ...
      <CardGroup cols={3}>
        ...
        <Card title="Make your first payout" icon="money-check-dollar-pen" href="/guides/creating-first-payout">
          Send fiat payouts. Use the Crypto API for crypto swaps and on-chain crypto payouts.
        </Card>
